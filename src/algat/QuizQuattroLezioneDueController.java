 ...
 * @author Simone
 */
public class QuizQuattroLezioneDueController implements Initializable {
    ...
    public void previousOne(ActionEvent event) throws IOException {
        Parent parent= FXMLLoader.load(getClass().getResource("quizTreLezioneDue.fxml"));
    ...
    public void nextOne(ActionEvent event) throws IOException {
        Parent nextQuiz = FXMLLoader.load(getClass().getResource("quizCinqueLezioneDue.fxml"));
