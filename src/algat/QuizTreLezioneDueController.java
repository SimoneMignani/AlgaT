 ...
 * @author Simone
 */
public class QuizTreLezioneDueController implements Initializable {
    ...
    public void previousOne(ActionEvent event) throws IOException {
        Parent parent= FXMLLoader.load(getClass().getResource("quizDueLezioneDue.fxml"));
    ...
    public void nextOne(ActionEvent event) throws IOException {
        Parent nextQuiz = FXMLLoader.load(getClass().getResource("quizQuattroLezioneDue.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        foto.setImage(new Image("file:img/aaa.jpg"));
    }    
