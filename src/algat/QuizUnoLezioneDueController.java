 ...
 * @author Simone
 */
public class QuizUnoLezioneDueController implements Initializable {
    ...
    public void backToLezione(ActionEvent event) throws IOException {
        Parent parent= FXMLLoader.load(getClass().getResource("lezioneDue.fxml"));
        Scene newScene = new Scene(parent);
        Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
        window.setScene(newScene);
        window.setTitle("AlgaT - Lezione Cammini Minimi");
        window.show();
    }

        //metodo che cambia la scene quando il bottone viene premuto
    public void nextOne(ActionEvent event) throws IOException {
        Parent nextQuiz = FXMLLoader.load(getClass().getResource("quizDueLezioneDue.fxml"));
